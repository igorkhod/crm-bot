# === Автогенерированный заголовок: crm2/handlers/admin_users.py
# Список верхнеуровневых объектов файла (классы и функции).
# Обновляется вручную при изменении состава функций/классов.
# Классы: —
# Функции: admin_users_entry, admin_users_pick_group
# === Конец автозаголовка
# crm2/handlers/admin_users.py
# Краткая аннотация: хендлеры подменю "Пользователи" (админ-панель)
