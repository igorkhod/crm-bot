# === Автогенерированный заголовок: crm2/handlers/admin_db_doctor.py
# Список верхнеуровневых объектов файла (классы и функции).
# Обновляется вручную при изменении состава функций/классов.
# Классы: —
# Функции: show_menu, action_sessions_info, action_fix_sessions, action_indexes, action_become_guest, action_become_user2, back_to_main
# === Конец автозаголовка
