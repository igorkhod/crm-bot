...
# Назначение: Навигационное меню для неавторизованных пользователей с точками входа в систему
# Функции: —
# Обработчики:
# - guest_login - Проверка существования учетной записи и предложение входа
# - guest_register - Перенаправление в модуль регистрации или уведомление о существующем аккаунте
# - guest_about - Информация о проекте Psytech CRM
# - back_to_guest_menu - Возврат в главное гостевое меню
